...
// Создаем элементы наименования магазинов
...
// Обрабатываем события нажатия на кнопки выбора магазина или товаров
...
// Функция отвечающая за создания элементов товаров
